...
// plaintext Secrets. The core has an identical copy in internal/harden:
// the two modules release independently, and the SDK's public surface stays
// the Backend interface (ADR-0004).
package harden
